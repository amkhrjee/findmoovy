...
<template>
  <div class="movie-list">
    <ul class="p-4 grid grid-cols-2 gap-4 md:grid-cols-5 lg:grid-cols-8">
      <li
        class="bg-navbar dark:bg-moviecard rounded-xl relative h-auto overflow-hidden drop-shadow-lg"
